...
Enabling the virtualization features here are actually optional but is encouraged if the table will be expected to render more than 100 rows at a time.
